...
;https://github.com/Emre37destan/KrDv-Hes-Degistir
...
!define APP_NAME "KrDv Hesap Degistir"
!define LNK_NAME "KrDv Hesap Degistir.lnk"
...
!define DESCRIPTION "KrDv Hesap Degistir"
!define LICENSE_TXT "..\..\LICENSE"
!define PRIVACY_TXT "..\..\PRIVACY.md"
!define MAIN_APP_EXE "KrDv-Hes-Degistir.exe"
!define INSTALL_TYPE "SetShellVarContext current"
!define REG_ROOT "HKCU"
!define REG_APP_PATH "Software\Microsoft\Windows\CurrentVersion\App Paths\${MAIN_APP_EXE}"
!define UNINSTALL_EXE "Uninstall KrDv Hesap Degistir.exe"
!define UNINSTALL_LNK_NAME "Uninstall KrDv Hesap Degistir.lnk"
!define UNINSTALL_PATH "Software\Microsoft\Windows\CurrentVersion\Uninstall\${APP_NAME}"
!define FIRST_RUN_EXE "_First_Run_Installer.exe"

!define REG_START_MENU "Start Menu Folder"
!define SM_Folder "KrDv Hesap Degistir"
...
!define INSTALLER_NAME "KrDv Hesap Degistir - Installer.exe"

!define INSTALLER_7Z "..\..\KrDv-Hes-Degistir-Client\bin\x64\Release\KrDv-Hes-Degistir.7z"

!define INSTALL_DIR "$PROGRAMFILES64\KrDv Hesap Degistir"
;;;;!define INSTALL_DIR "$PROGRAMFILES\KrDv Hesap Degistir"
...
;Interface Configuration
  ...
  !define UNINST_KEY "Software\Microsoft\Windows\CurrentVersion\Uninstall\KrDv-Hes-Degistir"
...
;Pages
  ...
  !define MUI_FINISHPAGE_LINK "https://github.com/Emre37destan/KrDv-Hes-Degistir"
  !define MUI_FINISHPAGE_LINK_LOCATION "https://github.com/Emre37destan/KrDv-Hes-Degistir"
...
Section "Main files" InstSec
  ...
  File "${INSTALLER_7Z}"
  SetCompress auto
  Nsis7z::ExtractWithDetails "$INSTDIR\KrDv-Hes-Degistir.7z" "Decompressing %s..."
  Delete "$OUTDIR\KrDv-Hes-Degistir.7z"  
  ...
  WriteRegStr HKLM "${UNINST_KEY}" "DisplayName" "KrDv Hesap Degistir"
