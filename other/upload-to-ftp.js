...
async function uploadFiles() {
  try {
    await uploadDirectory(
      "KrDv-Hes-Degistir-Client\\bin\\x64\\Release\\KrDv-Hes-Degistir",
    ...
    // Upload Hashes
    await uploadFile(
      'KrDv-Hes-Degistir-Client\\bin\\x64\\Release\\UpdateOutput\\hashes.json',
    ...
    await uploadFile(
      'KrDv-Hes-Degistir-Client\\bin\\x64\\Release\\UpdateDiff.7z',
