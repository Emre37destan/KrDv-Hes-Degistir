...
# -------------------------------
# Update the KrDv-Hes-Degistir-Client.csproj file
# -------------------------------

$csprojFilePath = "KrDv-Hes-Degistir-Client\KrDv-Hes-Degistir-Client.csproj"
...
Write-Host "UPDATED KrDv-Hes-Degistir-Client.csproj"

# -------------------------------
# Update the KrDv-Hes-Degistir-Server.csproj file
# -------------------------------

$csprojFilePath = "KrDv-Hes-Degistir-Server\KrDv-Hes-Degistir-Server.csproj"
...
Write-Host "UPDATED KrDv-Hes-Degistir-Server.csproj"

# -------------------------------
# Update the Globals.cs file
# -------------------------------

$globalsFilePath = "KrDv-Hes-Degistir-Globals\Globals.cs"
