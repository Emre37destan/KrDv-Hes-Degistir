...
namespace TcNo_Acc_Switcher_Server
{
    public class Startup
    {
        ...
        [
            @"SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall\KrDv-Hes-Degistir",
            @"SOFTWARE\WOW6432Node\Microsoft\Windows\CurrentVersion\Uninstall\KrDv-Hes-Degistir"
        ];
        ...
        public static void UpdateRegistryVersion(string version)
        {
            ...
            string uninstallExePath = Path.Combine(exeDirectory, "Uninstall KrDv Hesap Degistir.exe");
        ...
        private async static void UpdatePlatformsJson()
        {
            try
            {
                ...
                string latestPlatformsString = await client.GetStringAsync("https://raw.githubusercontent.com/Emre37destan/KrDv-Hes-Degistir/master/KrDv-Hes-Degistir-Server/Platforms.json");
                ...
                using (JsonDocument document = JsonDocument.Parse(File.ReadAllText(basicPlatformsPath))) {
                    ...
                    foreach (var platform in root.GetProperty("Platforms").EnumerateObject())
                    {
                        ...
                        string platformImageUrl = $"https://raw.githubusercontent.com/Emre37destan/KrDv-Hes-Degistir/master/KrDv-Hes-Degistir-Server/wwwroot/img/platform/{platformImage}.svg";
