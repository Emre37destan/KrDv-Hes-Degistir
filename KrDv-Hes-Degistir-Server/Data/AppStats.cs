...
namespace TcNo_Acc_Switcher_Server.Data
{
    public class AppStats
    {
        ...
        public static string GetStatsString()
        {
            ...
            GenerateTotals();
            SaveSettings();
            var returnString = $@"<h3>KrDv Hesap Degistir Stats - {DateTime.Now:yyyy-MM-dd HH:mm:ss}</h3><br>" +
   ...
   - <b>{Lang["Stats_GamesLaunched"]}</b>{switcherStat.Value.GamesLaunched}<br>";
        ...
        public static void UploadStats()
        {
            try
            {
                ...
                httpClient.DefaultRequestHeaders.Add("User-Agent", "KrDv Hesap Degistir");
