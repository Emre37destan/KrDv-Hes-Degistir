...
#pragma warning disable CA2211 // Non-constant fields should not be visible
        ...
        public static string StartMenu = Path.Join(Environment.GetFolderPath(Environment.SpecialFolder.Programs), @"KrDv Hesap Degistir\");
#pragma warning restore CA2211 // Non-constant fields should not be visible
        ...
        /// <summary>
        /// Fills in necessary info to create a shortcut to the KrDv Hesap Degistir
        /// </summary>
        ...
        public Shortcut Shortcut_Switcher(string location)
        {
            ...
            ShortcutPath = Path.Join(location, "KrDv Hesap Degistir.lnk");
            Desc = "KrDv Hesap Degistir";
            Args = "";
            return this;
        }
        ...
        public Shortcut Shortcut_Tray(string location)
        {
            ...
            Exe = Path.Join(ParentDirectory(GetSelfPath()), "KrDv-Hes-Degistir-Tray.exe");
            WorkingDir = Directory.GetCurrentDirectory();
            IconDir = Path.Join(WorkingDir, "wwwroot\\prog_icons\\program.ico");
            ShortcutPath = Path.Join(location, "KrDv Hesap Degistir - Tray.lnk");
            Desc = "KrDv Hesap Degistir - Tray";
            Args = "";
            return this;
        }
        ...
        /// <param name="descAdd">(Optional) Additional description to add to "KrDv Hesap Degistir - Steam</param>
        ...
        public Shortcut Shortcut_Platform(string location, string platformName = "Steam", string args = "steam", string descAdd = "", bool platformNameIsFullName = false)
        {
            ...
            ShortcutPath = Path.Join(location, (platformNameIsFullName ? platformName : $"{platformName} - KrDv Hesap Degistir") + ".lnk");
            Desc = $"KrDv Hesap Degistir - {platformName}" + descAdd != "" ? descAdd : "";
            Args = args;
            return this;
        }
        #endregion
        ...
        public static bool CheckShortcuts(string platform)
        {
            ...
            return File.Exists(Path.Join(Desktop, $"{platform} - KrDv Hesap Degistir.lnk"));
        }
        ...
        /// <summary>
        /// Checks if the KrDv Hesap Degistir Tray application has a Task to start with Windows
        /// </summary>
        public static bool StartWithWindows_Enabled() => File.Exists(Path.Join(Environment.GetFolderPath(Environment.SpecialFolder.Startup), "KrDv Hesap Degistir - Tray.lnk"));

        /// <summary>
        /// Toggles whether the KrDv Hesap Degistir Tray application starts with Windows or not
        /// </summary>
