...
namespace TcNo_Acc_Switcher_Tray
{
    ...
    {
        private readonly string _mainProgram = Path.Join(Path.GetDirectoryName(Process.GetCurrentProcess().MainModule?.FileName)!, "KrDv-Hes-Degistir_main.exe");
        ...
        private static bool AlreadyRunning() => Process.GetProcessesByName("KrDv-Hes-Degistir_main").Length > 0;
