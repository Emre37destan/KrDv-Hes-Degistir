...
<p align="center">
  <img alt="GitHub All Releases" src="https://img.shields.io/github/downloads/Emre37destan/KrDv-Hes-Degistir/total?logo=GitHub&style=flat-square">
  <a href="https://tcno.co/">
  ...
  <img alt="GitHub last commit" src="https://img.shields.io/github/last-commit/Emre37destan/KrDv-Hes-Degistir?logo=GitHub&style=flat-square">
  <img alt="GitHub repo size" src="https://img.shields.io/github/repo-size/Emre37destan/KrDv-Hes-Degistir?logo=GitHub&style=flat-square">
...
<p align="center"><a target="_blank" href="https://github.com/Emre37destan/KrDv-Hes-Degistir/releases/latest">
  <img alt="Download latest" src="/other/img/DownloadLatestNEW.png" height=70"></a>
  <a target="_blank" href="https://github.com/Emre37destan/KrDv-Hes-Degistir/wiki">
  <img alt="More info" src="/other/img/WikiButton.png" height=70"></a>
</p>
<p align="center"><a target="_blank" href="https://github.com/Emre37destan/KrDv-Hes-Degistir-Themes">
  <img alt="Themes" src="/other/img/Themes.png" height=70"></a>
  <a target="_blank" href="https://github.com/Emre37destan/KrDv-Hes-Degistir/wiki/Frequently-Asked-Questions">
...
### Things not working? See the [FAQ](https://github.com/Emre37destan/KrDv-Hes-Degistir/wiki/Frequently-Asked-Questions)
...
Code? Any and all help is appreciated. Specifically, currently the [build process for AppVeyor](https://github.com/Emre37destan/KrDv-Hes-Degistir/tree/appveyor). Otherwise, [adding platforms](https://github.com/Emre37destan/KrDv-Hes-Degistir/wiki/Help-code-a-platform) - No coding required!
...
*This list may not be up-to-date as platforms can now be added a lot faster. The new version adds the ability to easily create and maintain platforms by editing a simple text file `Platforms.json`. If you'd like to learn more, see this [Wiki page](https://github.com/Emre37destan/KrDv-Hes-Degistir/wiki/Help-code-a-platform).

[KrDv Hesap Degistir Install Guide](https://www.youtube.com/watch?v=sjJ8OZ_urJY&list=PLsSFD61FiOVmAwChPSrIFkjDLoLsyqcU6&index=1&t=27s)
...
- **Protocol support** to easily build access via other tools (`tcno:\\\<command>`) [CLI & Protocol Wiki](https://github.com/Emre37destan/KrDv-Hes-Degistir/wiki/CLI-&-Protocol)

\[For info on how any of these work, see the [Wiki](https://github.com/Emre37destan/KrDv-Hes-Degistir/wiki)]
...
**For manual runtime download and install**, see the [Wiki on this GitHub](https://github.com/Emre37destan/KrDv-Hes-Degistir/wiki#1-installing-required-runtimes)

### Visit the [Wiki](https://github.com/Emre37destan/KrDv-Hes-Degistir/wiki) for more info and steps for your first launch.
...
Head into the folder where you installed the program and run `_FIRST_RUN.exe` to make sure required runtimes are installed, and then run `KrDv-Hes-Degistir.exe` to run the main program. The second is what shortcuts to the program should point to.

**For a portable installation (eg. on a USB) see [THIS](https://github.com/Emre37destan/KrDv-Hes-Degistir/wiki#portable-eg-for-usb)** for steps on using the `.zip` or `.7z` below.

[See more info HERE](https://github.com/Emre37destan/KrDv-Hes-Degistir/wiki#2-running-the-tcno-account-switcher)
...
See this Wiki page: [Platform: Steam Legacy](https://github.com/Emre37destan/KrDv-Hes-Degistir/wiki/Platform:-Steam-Legacy).
...
https://github.com/Emre37destan/KrDv-Hes-Degistir/blob/master/LICENSE - See sections like 15, 16 and 17, as well as GitHub's
'simplification' at the top of the above website.
```

Additional license information for included NuGet packages and other parts of code can be found in: [HERE](https://github.com/Emre37destan/KrDv-Hes-Degistir/blob/master/KrDv-Hes-Degistir-Server/Additional%20Licenses.txt) `KrDv-Hes-Degistir-Server/Additional Licenses.txt`, and are copied to the build directory, as well as distributed with release versions of this software.
