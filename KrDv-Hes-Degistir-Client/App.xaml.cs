...
#pragma warning restore CA2211 // Non-constant fields should not be visible
        ...
        protected override async void OnStartup(StartupEventArgs e)
        {
            ...
            {
                MessageBox.Show("Can't access log.txt in the KrDv Hesap Degistir directory!",
            ...
            if (Directory.Exists("newUpdater"))
            {
                ...
                catch (IOException)
                {
                    ...
                    Globals.KillProcess("KrDv-Hes-Degistir-Updater");
                    Globals.RecursiveDelete("updater", false);
                }
...
release = true;
                ...
                if (!NativeFuncs.BringToFront())
                {
	                text = "Another KrDv Hesap Degistir instance has been detected." + Environment.NewLine +
	                       "[Something wrong? Hold Hold Alt, Ctrl, Shift or Scroll Lock while starting to close all TcNo processes!]";

                    _ = MessageBox.Show(text, "KrDv Hesap Degistir Notice", MessageBoxButton.OK,
                ...
                else
                {
	                ...
	                {
		                text = "KrDv Hesap Degistir was running." + Environment.NewLine +
        ...
        /// <summary>
        /// CLI specific interface for KrDv Hesap Degistir
        ...
        {
            Console.WriteLine(@"Welcome to the KrDv Hesap Degistir - Command Line Interface!");
