...
namespace TcNo_Acc_Switcher_Client
{
    ...
    public partial class MainWindow
    {
        ...
        {
            const string serverPath = "KrDv-Hes-Degistir-Server_main.exe";
            ...
            if (attempts == 10)
                MessageBox.Show("The KrDv-Hes-Degistir-Server.exe attempted to launch 10 times and failed every time. Every attempted port is taken, or another issue occurred. Check the log file for more info.", "Server start failed!", MessageBoxButton.OK, MessageBoxImage.Error);
        }
        ...
        public static void Restart(string args = "", bool admin = false)
        {
            var proc = new ProcessStartInfo
            {
                ...
                FileName = Assembly.GetEntryAssembly()?.Location.Replace(".dll", ".exe") ?? "KrDv-Hes-Degistir_main.exe",
                UseShellExecute = true,
                Arguments = args,
                Verb = admin ? "runas" : ""
            };
