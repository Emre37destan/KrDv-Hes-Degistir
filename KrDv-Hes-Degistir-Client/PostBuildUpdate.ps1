...
$apiUrl = "https://api.github.com/repos/Emre37destan/KrDv-Hes-Degistir/releases/latest"

# Define the local paths
$downloadPath = "LAST-KrDv-Hes-Degistir_and_CEF.7z"
...
# -----------------------------------
$updaterPath = "updater\KrDv-Hes-Degistir-Updater.exe"
...
ExtractFile -filePath "KrDv-Hes-Degistir.7z" -outputPath "KrDv-Hes-DegistirUnzipped"

# Use 7z to compress the contents of KrDv-Hes-Degistir
Write-Host "- Compressing as .zip"
Compress-Archive -Path "KrDv-Hes-DegistirUnzipped\*" -DestinationPath "KrDv-Hes-Degistir.zip"
...
$filesToCopy = @(
    "KrDv Hesap Degistir - Installer.exe",
    "KrDv-Hes-Degistir.7z",
    "KrDv-Hes-Degistir.zip",
    "KrDv-Hes-Degistir_and_CEF.7z"
)
