...
int finalizeUpdate(std::string sfrom, std::string sto) {
	SetConsoleTitle(_T("KrDv Hesap Degistir - Finalizing Update..."));
	...
	// Launch the main program from sto/KrDv-Hes-Degistir.exe in sto
	std::string exe_name = "KrDv-Hes-Degistir.exe";
...
int main(int argc, char* argv[])
{
	...
	SetConsoleTitle(_T("KrDv Hesap Degistir - Runtime installer"));
	cout << "Welcome to the KrDv Hesap Degistir - Runtime installer" << endl <<
		"------------------------------------------------------------------------" << endl << endl;
	...
	// Launch main program:
	if (!args_contain("nostart", argc, argv)) {
		string exe_name = "KrDv-Hes-Degistir.exe";
