...
inline void download_install_missing_runtimes()
{
	...
	cout << " - Windows Desktop Runtime 8.0.8+" << endl <<
		...
		"------------------------------------------------------------------------" << endl << endl <<
		"That should be everything. The main program, KrDv-Hes-Degistir.exe, will auto-run." << endl << endl <<
		"If it doesn't work, please refer to install instructions, here:" << endl <<
		"https://github.com/Emre37destan/KrDv-Hes-Degistir#required-runtimes-download-and-install" << endl << endl;
}
